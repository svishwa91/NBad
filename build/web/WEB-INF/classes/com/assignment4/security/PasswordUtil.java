...
public class PasswordUtil {
    ...
    public static String getSalt() {
        ...
        return Base64.encodeBytes(saltBytes);
    }
    ...
    public static HashMap<String,String> gethashAndSaltPassword(String password)
            throws NoSuchAlgorithmException {
        String salt = getSalt();
        HashMap<String,String> map=new HashMap<String,String>();
        map.put("hashedPassword",hashPassword(password + salt));
        map.put("salt",salt);
        return map;
    }
